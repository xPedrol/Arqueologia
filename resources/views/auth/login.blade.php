<!DOCTYPE html>
<!-- saved from url=(0040)https://arqueologia.lampeh.ufv.br/login/ -->
<html lang="pt-BR" itemscope="" itemtype="http://schema.org/WebPage">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">

    <link rel="profile" href="http://gmpg.org/xfn/11">
    <title>LOGIN – Patrimônio Arqueológico</title>
    ...
    <link rel="canonical" href="https://arqueologia.lampeh.ufv.br/login/">
    <link rel="shortlink" href="https://arqueologia.lampeh.ufv.br/?p=47">
    <link rel="alternate" type="application/json+oembed"
          href="https://arqueologia.lampeh.ufv.br/wp-json/oembed/1.0/embed?url=https%3A%2F%2Farqueologia.lampeh.ufv.br%2Flogin%2F">
    <link rel="alternate" type="text/xml+oembed"
          href="https://arqueologia.lampeh.ufv.br/wp-json/oembed/1.0/embed?url=https%3A%2F%2Farqueologia.lampeh.ufv.br%2Flogin%2F&amp;format=xml">
...
<body
    class="page-template-default page page-id-47 custom-background wp-embed-responsive um-page-login um-page-loggedout sinatra-topbar__separators-regular sinatra-layout__fw-contained sinatra-header-layout-1 sinatra-menu-animation-underline sinatra-header__separators-none si-page-title-align-left si-has-sidebar sinatra-sidebar-style-1 sinatra-sidebar-position__right-sidebar si-sidebar-r__after-content entry-media-hover-style-1 sinatra-copyright-layout-1 si-input-supported validate-comment-form si-menu-accessibility elementor-default elementor-kit-65 using-keyboard"
...
<div id="page" class="hfeed site">
    <a class="skip-link screen-reader-text" href="https://arqueologia.lampeh.ufv.br/login/#content">Skip to content</a>
        ...
        <div class="si-container">
            ...
            <div class="si-page-header-wrapper">
                ...
                <div class="si-page-header-title">
                    <h1 class="page-title" itemprop="headline">LOGIN</h1></div>
            ...
            <div class="si-breadcrumbs">
                <nav role="navigation" aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs"
                    ...
                    <ul class="trail-items" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem"
                            class="trail-item trail-end"><span><span itemprop="name">LOGIN</span></span>
        ...
        <div class="si-container">
            ...
            <div id="primary" class="content-area">
                ...
                <main id="content" class="site-content" role="main" itemtype="http://schema.org/WebPageElement"
                    ...
                    <article id="post-47" class="post-47 page type-page status-publish hentry" itemscope=""
                             itemtype="https://schema.org/CreativeWork">


                        <div class="entry-content si-entry">

                            <div class="um um-login um-43 uimob500" style="opacity: 1;">
                                @if(!Auth::check())
                                <div class="um-form">
                                    @if(Session::has('error'))
                                        <div class="alert alert-danger" role="alert">
                                            <p class="um-notice err um-error-code-incorrect_password"><i
                                                    class="um-icon-ios-close-empty"
                                                    onclick="jQuery(this).parent().fadeOut();"></i> {{Session::get('error')}}
                                            </p>
                                        </div>
                                    @endif
                                    <form method="post" action="{{route('logging')}}" autocomplete="off">
                                        ...
                                        <div class="um-row _um_row_1 " style="margin: 0 0 30px 0;">
                                            <div class="um-col-1">
                                                <div id="um_field_43_username"
                                                     class="um-field um-field-text  um-field-username um-field-text um-field-type_text"
                                                     data-key="username">
                                                    <div class="um-field-label"><label for="username-43">E-mail</label>
                                                ...
                                                <div id="um_field_43_user_password"
                                                    ...
                                                    <div class="um-field-label"><label
                                                            for="user_password-43">Senha</label>
                                                        <div class="um-clear"></div>
                                                    </div>
                                                    <div class="um-field-area">
                                        ...
                                        <input type="hidden" name="form_id" id="form_id_43" value="43">

                                        <p class="um_request_name">
                                            <label for="um_request_43">Only fill in if you are not human</label>
                                            <input type="hidden" name="um_request" id="um_request_43" class="input"
                                                   value="" size="25" autocomplete="off">
                                        </p>

                                        <input type="hidden" id="_wpnonce" name="_wpnonce" value="c58339404a"><input
                                        ...
                                        <div class="um-col-alt">
                                            ...
                                            <div class="um-right um-half">
                                                <a href="https://arqueologia.lampeh.ufv.br/register/"
                                        ...
                                        <div class="um-col-alt-b">
                                            <a href="https://arqueologia.lampeh.ufv.br/password-reset/"
                                               class="um-link-alt">
                                    ...
                                    <div class="um-form">
                                        ...
                                        <div class="um-misc-with-img">
                                            ...
                                            <div class="um-misc-img">
                                                <a href="https://arqueologia.lampeh.ufv.br/user/">
                                                    <img src="https://arqueologia.lampeh.ufv.br/wp-content/plugins/ultimate-member/assets/img/default_avatar.jpg" class="gravatar avatar avatar-80 um-avatar um-avatar-default" width="80" height="80" alt="Pedro Lucas Santos Ferreira" data-default="https://arqueologia.lampeh.ufv.br/wp-content/plugins/ultimate-member/assets/img/default_avatar.jpg" onerror="if ( ! this.getAttribute('data-load-error') ){ this.setAttribute('data-load-error', '1');this.setAttribute('src', this.getAttribute('data-default'));}">				</a>
                                            </div>

                                            <div><strong>{{auth()->user()->login}}</strong></div>
...
{{--                                            <li>--}}
{{--                                                <a href="https://arqueologia.lampeh.ufv.br/account/">--}}
{{--                                                    Your account		</a>--}}
{{--                                            </li>--}}
                                            <li>
                                                <a href="{{route('logout')}}">
...
<a href="https://arqueologia.lampeh.ufv.br/login/#" id="si-scroll-top" class="si-smooth-scroll" title="Scroll to Top">
