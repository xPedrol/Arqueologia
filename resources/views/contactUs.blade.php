<x-layout :title="'Fale Conosco'">
    <x-slot name="assets">
        <meta name="description" content="Entre em contato com o Arquivo da Câmara Municipal de Viçosa">
    </x-slot>
    <x-slot name="content">
                ...
                <div class="col-12 col-lg-8">
                    <form method="POST" action="{{route('contactUsPost')}}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('texto') is-invalid @enderror" name="texto" id="texto" rows="5" placeholder="Digite uma descrição"></textarea>
                            @error('texto')
                            <div class="invalid-feedback">
                                Campo inválido
                            </div>
