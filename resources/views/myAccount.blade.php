        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    <form method="POST" action="{{route('savingAccountChanges')}}">
                        @method('POST')
                        @csrf
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label for="socialName" class="form-label">Nome</label>
                                <input type="text" class="form-control @error('nome') is-invalid @enderror" name="socialName"
                                       id="socialName" aria-describedby="socialName" value="{{auth()->user()->socialName}}"
                            ...
                            <div class="col-md-5 mb-3">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" name="email"
                                       id="email" aria-describedby="emailHelp" readonly value="{{auth()->user()->email}}"
