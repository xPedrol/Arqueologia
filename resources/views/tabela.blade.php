<!DOCTYPE html>
<!-- saved from url=(0048)https://arqueologia.lampeh.ufv.br/tabela/?id=619 -->
<html lang="pt-BR" itemscope="" itemtype="http://schema.org/WebPage">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">

    <link rel="profile" href="http://gmpg.org/xfn/11">
    <title>Tabela – Patrimônio Arqueológico</title>
    ...
    <link rel="alternate" type="application/json" href="https://arqueologia.lampeh.ufv.br/wp-json/wp/v2/pages/289">
    ...
    <link rel="canonical" href="https://arqueologia.lampeh.ufv.br/tabela/">
    <link rel="shortlink" href="https://arqueologia.lampeh.ufv.br/?p=289">
    <link rel="alternate" type="application/json+oembed"
          href="https://arqueologia.lampeh.ufv.br/wp-json/oembed/1.0/embed?url=https%3A%2F%2Farqueologia.lampeh.ufv.br%2Ftabela%2F">
    <link rel="alternate" type="text/xml+oembed"
          href="https://arqueologia.lampeh.ufv.br/wp-json/oembed/1.0/embed?url=https%3A%2F%2Farqueologia.lampeh.ufv.br%2Ftabela%2F&amp;format=xml">
...
<body
    class="page-template-default page page-id-289 custom-background wp-embed-responsive sinatra-topbar__separators-regular sinatra-layout__fw-contained sinatra-header-layout-1 sinatra-menu-animation-underline sinatra-header__separators-none si-page-title-align-left si-has-sidebar sinatra-sidebar-style-1 sinatra-sidebar-position__right-sidebar si-sidebar-r__after-content entry-media-hover-style-1 sinatra-copyright-layout-1 si-input-supported validate-comment-form si-menu-accessibility elementor-default elementor-kit-65 using-keyboard"
                ...
                <nav role="navigation" aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs"
                    ...
                    <ul class="trail-items" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem"
                            class="trail-item trail-begin"><a href="{{route('home')}}" rel="home"
                                                              itemprop="item"><span itemprop="name">Home</span></a>
                            <meta itemprop="position" content="1">
                        </li>
                        <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem"
                            class="trail-item trail-begin"><a href="{{route('fontes')}}" rel="home"
                                                              itemprop="item"><span itemprop="name">Fontes</span></a>
                            <meta itemprop="position" content="1">
                        </li>
                        <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem"
                            class="trail-item trail-end"><span><span itemprop="name">Tabela</span></span>
                            ...
                            @if(count($array) > 0)
                                @if(!isset($isIbgeHistorico))
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <x-pagination :params="['id'=>$cidade->id]" :query="$query" :maxPage="$maxPage" :route="$route"/>
                                    </div>
                                @else
                                    <div>
                                        @foreach($array as $row)
...
<a href="https://arqueologia.lampeh.ufv.br/tabela/?id=619#" id="si-scroll-top" class="si-smooth-scroll"
   title="Scroll to Top">
...
<script type="text/javascript">
    window['ninja_table_instance_0'] = {
        ...
        "columns": [{
            ...
            "type": "text",
            "visible": true,
            "classes": ["ninja_column_0", "ninja_clmn_nm_historico"],
            "filterable": true,
            "sortable": true
        }],
        "original_columns": [{
        ...
        "settings": {
            ...
            "expandFirst": false,
            "expandAll": false,
            "i18n": {"search_in": "Search in", "search": "Search", "no_result_text": "No Result Found"},
        ...
        "custom_css": {"ninja_column_0": []},
        "instance_name": "ninja_table_instance_0",
        "table_version": "4.2.3",
        "provider": "default",
        "uniqueID": "ninja_table_unique_id_1282718211_619",
        "init_config": {
            "toggleColumn": "first",
            "cascade": true,
            ...
            "data_request_url": "https:\/\/arqueologia.lampeh.ufv.br\/wp-admin\/admin-ajax.php?action=wp_ajax_ninja_tables_public_action&table_id=619&target_action=get-all-data&default_sorting=old_first&ninja_table_public_nonce=0a6d88eaec",
            "filtering": {
                "enabled": true,
                "delay": 1,
            ...
            "paging": {
                ...
                "position": "right",
                "size": 20,
                "container": "#footable_parent_619 .paging-ui-container",
                "countFormat": " "
            }
        }
    }            </script>
<link rel="stylesheet" id="footable_styles-css" href="/fullcss/ninjatables-public.css" media="all">
...
<script id="um_scripts-js-extra">
    var um_scripts = {"max_upload_size": "8589934592", "nonce": "fee21d9dab"};
</script>
...
<script src="/fullcss/footable.min.js.download" id="footable-js"></script>
<script id="footable_init-js-extra">
    var ninja_footables = {
        "ajax_url": "https:\/\/arqueologia.lampeh.ufv.br\/wp-admin\/admin-ajax.php",
        "tables": [],
        "ninja_version": "4.2.3",
        "i18n": {"search_in": "Search in", "search": "Search", "empty_text": "No Result Found"},
        "ninja_table_public_nonce": "0a6d88eaec"
    };
</script>
<script src="/fullcss/ninja-tables-footable.3.1.0.js.download" id="footable_init-js"></script>
<script>
    !function () {
